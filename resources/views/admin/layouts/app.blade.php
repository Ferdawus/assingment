                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">
                            ...
                            <div class="media">
                                <img src="https://adminlte.io/themes/v3/admin-lte/dist/img/user1-128x128.jpg" alt="User Avatar"
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <router-link :to="{name: 'Client'}" class="nav-link" active-class="active">
                        ...
                        <li class="nav-item">
                            <router-link :to="{name: 'User'}" class="nav-link" active-class="active">
                                <i class="nav-icon fas fa-user"></i>
                                <p>
                                  Users
                                </p>
