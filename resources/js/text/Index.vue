      ...
      <div class="card">
        ...
        <div class="my-2 px-4">
          <div class="row">
            ...
            <div class="col-md-2">
              <button @click="realoadData()" class="btn btn-primary ml-2">
                Reload
              </button>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-12">
                  ...
                  <tr v-for="(client, index) in clients" :key="index">
                    ...
                    <td>
                      <a
                        ...
                        @click.prevent="editData(client.id)"
                        >Edit</a
                      >
                      <a
                        href=""
              ...
              <pagination
                ...
                :offset="5"
                @paginate="query === '' ? fachData() : searchData()"
              >
              </pagination>
            </div>
          </div>
              ...
              <div class="modal-body">
                <div class="mb-3">
                  ...
                  >
                    ...
                    <option v-for="(Medicine, index) in medicines" :key="index">{{ Medicine.medicineName }}</option>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form @submit.prevent="dataUpdate()" action="">
              <input type="hidden" v-model="editFrom.id" id="IDEdit" />
              <div class="modal-body">
                <div class="mb-3">
                  <label for="exampleFormControlInput1" class="form-label"
                    >Name</label
